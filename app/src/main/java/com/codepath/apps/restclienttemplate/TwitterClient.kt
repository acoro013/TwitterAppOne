...
class TwitterClient(context: Context) : OAuthBaseClient(
    ...
    companion object {
        val REST_API_INSTANCE = TwitterApi.instance() //first step 1

        //trying to conect to twitter api and this rest URL
        const val REST_URL = "https://api.twitter.com/1.1" // Change this, base API URL, step 2
    ...
    fun getHomeTimeline(handler: JsonHttpResponseHandler) {
        ...
        //how many tweets we are returning
        params.put("count", "25")
        //Give me back the most recent tweets, used for pull to refresh feature
